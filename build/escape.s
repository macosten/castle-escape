...
L4B73:
	.byte	$44,$65,$63,$20,$32,$36,$20,$32,$30,$32,$35,$00
L4067:
...
L4B7E:
	.byte	$31,$38,$3A,$32,$32,$3A,$33,$36,$00
L4045:
...
;
L5D6C:	lda     _level_index
	asl     a
	bcc     L5D64
	inx
	clc
L5D64:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
; if (advanced_conditional && level_index_backup != 0xff) {
;
L4993:	lda     _advanced_conditional
	beq     L5D70
	lda     _level_index_backup
	cmp     #$FF
	beq     L5D70
...
;
L5D70:	lda     _game_level_advance_behavior
	beq     L5D71
	lda     _level_index
	cmp     #$25
	bne     L5D72
...
;
	jmp     L5DEB
L5DD8:	lda     _valrigard+3
	cmp     #$F1
	bcc     L5DD9
	ldx     #$F0
	lda     #$00
L5DEB:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L5DD9:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L5DE3:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L5DE4:	lda     _valrigard+3
	cmp     #$F0
	bcc     L5395
;
...
; SET_STATUS_DEAD();    
;
L5DE5:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L5395:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L5E50:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L5E71:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L4C07
L4C05:	lda     _string_off
	ldx     _string_off+1
L4C07:	sta     _temppointer
	stx     _temppointer+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L4BD2
L4BD0:	lda     _string_off
	ldx     _string_off+1
L4BD2:	sta     _temppointer
	stx     _temppointer+1
;
