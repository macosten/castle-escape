...
L2A65:
	.byte	$4E,$6F,$76,$20,$31,$37,$20,$32,$30,$32,$31,$00
L25AF:
...
L2A70:
	.byte	$32,$33,$3A,$32,$36,$3A,$32,$33,$00
L2595:
...
; valrigard.velocity_x = 0;
;
L3937:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L2FEA:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L394F
L3941:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3942
	ldx     #$F0
	lda     #$00
L394F:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3942:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3949:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L309F:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L39A0:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
