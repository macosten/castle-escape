...
;
	...
	inx
	clc
L2DFB:	adc     #<(_level_compressed_nametable_pointers)
	sta     ptr1
	txa
...
; valrigard.velocity_x = 0;
;
L2E21:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L24D8:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L2E2F
L2E28:	lda     _valrigard+3
	cmp     #$F1
	lda     #$00
	bcc     L2E2A
	ldx     #$F0
L2E2F:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; L_R_switch = 0;
;
L2E2A:	sta     _L_R_switch
;
; hitbox.x = high_byte(valrigard.x);
;
	lda     _valrigard+1
...
;
	...
	inx
	clc
L2E3F:	adc     #<(_tile_clear_attr_addr_queue)
	sta     ptr1
	txa
...
;
L2669:	lda     _temp_mutablepointer
	ldx     _temp_mutablepointer+1
	clc
	adc     _coordinates
	bcc     L2E4A
...
;
	...
	inx
	clc
L2E4E:	adc     #<(_tile_clear_attr_addr_queue)
	sta     ptr1
	txa
	adc     #>(_tile_clear_attr_addr_queue)
	sta     ptr1+1
...
;
	...
	inx
	clc
L2E81:	adc     #<(_cannon_sprite_quadrant_lookup_table)
	sta     ptr1
	txa
...
;
	...
	sta     _TEMP+1
	lda     #$01
L2E95:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
; draw_screen_U();
;
L2080:	jsr     _draw_screen_U
;
; handle_tile_clear_queue();
;
L2083:	jsr     _handle_tile_clear_queue
;
...
;
L2089:	jsr     _gray_line
;
; while (game_mode == MODE_GAME) {
;
L2EBF:	lda     _game_mode
	cmp     #$01
	beq     L2068
;
