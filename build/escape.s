...
;
	...
	inx
	clc
L0952:	adc     #<(_korbat_sprite_lookup_table)
	sta     ptr1
	txa
...
; collision = c_map[coordinates];
;
L0909:	ldy     _coordinates
	lda     _c_map,y
L09AD:	sta     _collision
;
; if (!METATILE_IS_SOLID(collision)) {
;
	cmp     #$17
