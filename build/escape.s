...
L2EFB:
	.byte	$4A,$61,$6E,$20,$32,$35,$20,$32,$30,$32,$32,$00
L28B4:
...
L2F06:
	.byte	$30,$32,$3A,$33,$36,$3A,$30,$36,$00
L28A4:
...
;
	jmp     L407C
L406B:	lda     _valrigard+3
	cmp     #$F1
	bcc     L406C
	ldx     #$F0
	lda     #$00
L407C:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L406C:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L4076:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L3648:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L40E0:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L2FA2
L2FA0:	lda     _string_off
	ldx     _string_off+1
L2FA2:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L410F:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L2F59
L2F57:	lda     _string_off
	ldx     _string_off+1
L2F59:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L2D3D:	lda     _game_level_advance_behavior
	beq     L4118
	lda     _level_index
	cmp     #$1A
	bne     L4119
...
;
L2D63:	jsr     _gray_line
;
; while (game_mode == MODE_GAME) {
;
L4123:	lda     _game_mode
	cmp     #$01
	jeq     L4117
;
