...
L49C9:
	.byte	$32,$31,$3A,$31,$39,$3A,$33,$35,$00
L4030:
...
;
	...
	ldx     _string_on+1
	jmp     L4A52
L4A50:	lda     _string_off
	ldx     _string_off+1
L4A52:	sta     _temppointer
	stx     _temppointer+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L4A1D
L4A1B:	lda     _string_off
	ldx     _string_off+1
L4A1D:	sta     _temppointer
	stx     _temppointer+1
;
