...
L4CD3:
	.byte	$46,$65,$62,$20,$32,$36,$20,$32,$30,$32,$36,$00
L407C:
...
L4CDE:
	.byte	$31,$38,$3A,$30,$39,$3A,$31,$39,$00
L405C:
...
;
L5F6D:	lda     _level_index
	asl     a
	bcc     L5F65
	inx
	clc
L5F65:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
; if (advanced_conditional && level_index_backup != 0xff) {
;
L4AD6:	lda     _advanced_conditional
	beq     L5F71
	lda     _level_index_backup
	cmp     #$FF
	beq     L5F71
...
;
L5F71:	lda     _game_level_advance_behavior
	beq     L5F72
	lda     _level_index
	cmp     #$25
	bne     L5F73
...
;
	jmp     L5FEE
L5FDB:	lda     _valrigard+3
	cmp     #$F1
	bcc     L5FDC
	ldx     #$F0
	lda     #$00
L5FEE:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L5FDC:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L5FE6:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L5FE7:	lda     _valrigard+3
	cmp     #$F0
	bcc     L5587
;
...
; SET_STATUS_DEAD();    
;
L5FE8:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L5587:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L6053:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L6074:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
; if (HAS_IGLOO_TROPHY) {
;
L4D8F:	lda     _igloo_1p_high_score
	cmp     #$E8
...
;
	...
	ldx     _string_on+1
	jmp     L4D32
L4D30:	lda     _string_off
	ldx     _string_off+1
L4D32:	sta     _temppointer
	stx     _temppointer+1
;
