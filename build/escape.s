...
L2BF6:
	.byte	$30,$34,$3A,$30,$35,$3A,$30,$36,$00
L25A0:
...
; valrigard.velocity_x = 0;
;
L3B49:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L31FC:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L3B61
L3B53:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3B54
	ldx     #$F0
	lda     #$00
L3B61:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3B54:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3B5B:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L32B1:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L3BB2:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L2C92
L2C90:	lda     _string_off
	ldx     _string_off+1
L2C92:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L3BE7:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L2C49
L2C47:	lda     _string_off
	ldx     _string_off+1
L2C49:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L2A2E:	lda     _game_level_advance_behavior
	beq     L3BEF
	lda     _level_index
	cmp     #$18
	bne     L3BF0
