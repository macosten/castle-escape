...
L2A56:
	.byte	$41,$75,$67,$20,$32,$32,$20,$32,$30,$32,$31,$00
L25AF:
...
L2A61:
	.byte	$31,$37,$3A,$35,$38,$3A,$30,$31,$00
L2595:
...
; valrigard.velocity_x = 0;
;
L391D:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L2FD4:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L3935
L3927:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3928
	ldx     #$F0
	lda     #$00
L3935:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3928:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L392F:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L3089:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L3986:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
