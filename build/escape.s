...
L2E5A:
	.byte	$31,$35,$3A,$35,$33,$3A,$35,$34,$00
L27F6:
...
; valrigard.velocity_x = 0;
;
L3D8D:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L3461:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L3DA5
L3D97:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3D98
	ldx     #$F0
	lda     #$00
L3DA5:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3D98:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3D9F:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L3516:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L3DF3:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L2EF6
L2EF4:	lda     _string_off
	ldx     _string_off+1
L2EF6:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L3E22:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L2EAD
L2EAB:	lda     _string_off
	ldx     _string_off+1
L2EAD:	sta     _temppointer
	stx     _temppointer+1
;
