...
L4CB4:
	.byte	$31,$31,$3A,$34,$39,$3A,$34,$31,$00
L405C:
...
;
L5FBA:	lda     _level_index
	asl     a
	bcc     L5FB2
	inx
	clc
L5FB2:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
; if (advanced_conditional && level_index_backup != 0xff) {
;
L4AAC:	lda     _advanced_conditional
	beq     L5FBE
	lda     _level_index_backup
	cmp     #$FF
	beq     L5FBE
...
;
L5FBE:	lda     _game_level_advance_behavior
	beq     L5FBF
	lda     _level_index
	cmp     #$25
	bne     L5FC0
...
;
	jmp     L603B
L6028:	lda     _valrigard+3
	cmp     #$F1
	bcc     L6029
	ldx     #$F0
	lda     #$00
L603B:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L6029:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L6033:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L6034:	lda     _valrigard+3
	cmp     #$F0
	bcc     L55D4
;
...
; SET_STATUS_DEAD();    
;
L6035:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L55D4:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L60A0:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L60C1:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L4D4A
L4D48:	lda     _string_off
	ldx     _string_off+1
L4D4A:	sta     _temppointer
	stx     _temppointer+1
;
...
; if (HAS_IGLOO_TROPHY) {
;
L4D73:	lda     _igloo_1p_high_score
	cmp     #$E8
...
;
	...
	ldx     _string_on+1
	jmp     L4CFC
L4CFA:	lda     _string_off
	ldx     _string_off+1
L4CFC:	sta     _temppointer
	stx     _temppointer+1
	jsr     _put_str_sub
;
...
;
	...
	ldx     _string_on+1
	jmp     L4D0C
L4D0A:	lda     _string_off
	ldx     _string_off+1
L4D0C:	sta     _temppointer
	stx     _temppointer+1
	jsr     _put_str_sub
;
