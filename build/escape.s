...
L2A61:
	.byte	$30,$32,$3A,$33,$37,$3A,$31,$34,$00
L2595:
...
;
	jmp     L391C
L390F:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3910
	ldx     #$F0
	lda     #$00
L391C:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3910:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L396A:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
