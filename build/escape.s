...
L49B5:
	.byte	$53,$65,$70,$20,$20,$38,$20,$32,$30,$32,$35,$00
L4052:
...
L49C0:
	.byte	$30,$30,$3A,$31,$33,$3A,$30,$33,$00
L4030:
...
;
L5B6A:	lda     _level_index
	asl     a
	bcc     L5B62
	inx
	clc
L5B62:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
; if (advanced_conditional && level_index_backup != 0xff) {
;
L47D5:	lda     _advanced_conditional
	beq     L5B6E
	lda     _level_index_backup
	cmp     #$FF
	beq     L5B6E
...
;
L5B6E:	lda     _game_level_advance_behavior
	beq     L5B6F
	lda     _level_index
	cmp     #$25
	bne     L5B70
...
;
	jmp     L5BE9
L5BD6:	lda     _valrigard+3
	cmp     #$F1
	bcc     L5BD7
	ldx     #$F0
	lda     #$00
L5BE9:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L5BD7:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L5BE1:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L5BE2:	lda     _valrigard+3
	cmp     #$F0
	bcc     L5193
;
...
; SET_STATUS_DEAD();    
;
L5BE3:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L5193:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L5C4E:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L5C6F:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L4A49
L4A47:	lda     _string_off
	ldx     _string_off+1
L4A49:	sta     _temppointer
	stx     _temppointer+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L4A14
L4A12:	lda     _string_off
	ldx     _string_off+1
L4A14:	sta     _temppointer
	stx     _temppointer+1
;
