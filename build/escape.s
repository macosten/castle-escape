...
L2E59:
	.byte	$32,$31,$3A,$30,$36,$3A,$32,$34,$00
L27F4:
...
; valrigard.velocity_x = 0;
;
L3E97:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L34DE:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L3EAF
L3EA1:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3EA2
	ldx     #$F0
	lda     #$00
L3EAF:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3EA2:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3EA9:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L3593:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L3F06:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L3F35:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
