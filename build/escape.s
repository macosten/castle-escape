...
L4CAC:
	.byte	$31,$35,$3A,$35,$38,$3A,$32,$35,$00
L405C:
...
;
L605B:	lda     _level_index
	asl     a
	bcc     L6053
	inx
	clc
L6053:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
;
L605F:	lda     _game_level_advance_behavior
	beq     L6060
	lda     _level_index
	cmp     #$25
	bne     L6061
...
;
	jmp     L60DC
L60C9:	lda     _valrigard+3
	cmp     #$F1
	bcc     L60CA
	ldx     #$F0
	lda     #$00
L60DC:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L60CA:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L60D4:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L60D5:	lda     _valrigard+3
	cmp     #$F0
	bcc     L5675
;
...
; SET_STATUS_DEAD();    
;
L60D6:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L5675:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L6141:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L6162:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L4D42
L4D40:	lda     _string_off
	ldx     _string_off+1
L4D42:	sta     _temppointer
	stx     _temppointer+1
;
...
; if (HAS_IGLOO_TROPHY) {
;
L4D6B:	lda     _igloo_1p_high_score
	cmp     #$E8
...
;
	...
	inx
	clc
L6179:	adc     #<(_deckswabber_1p_high_scores)
	sta     ptr1
	txa
...
;
	...
	ldx     _string_on+1
	jmp     L4CF4
L4CF2:	lda     _string_off
	ldx     _string_off+1
L4CF4:	sta     _temppointer
	stx     _temppointer+1
	jsr     _put_str_sub
;
...
;
	...
	ldx     _string_on+1
	jmp     L4D04
L4D02:	lda     _string_off
	ldx     _string_off+1
L4D04:	sta     _temppointer
	stx     _temppointer+1
	jsr     _put_str_sub
;
...
;
	...
	inx
	clc
L6184:	adc     #<(_deckswabber_1p_high_scores)
	sta     ptr1
	txa
	adc     #>(_deckswabber_1p_high_scores)
	sta     ptr1+1
