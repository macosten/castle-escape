...
L2BE7:
	.byte	$4E,$6F,$76,$20,$32,$35,$20,$32,$30,$32,$31,$00
L25AF:
...
L2BF2:
	.byte	$32,$31,$3A,$30,$33,$3A,$30,$37,$00
L2599:
...
; valrigard.velocity_x = 0;
;
L3B3F:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L31F2:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L3B57
L3B49:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3B4A
	ldx     #$F0
	lda     #$00
L3B57:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3B4A:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3B51:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L32A7:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L3BA8:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L2C8E
L2C8C:	lda     _string_off
	ldx     _string_off+1
L2C8E:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L3BDD:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L2C45
L2C43:	lda     _string_off
	ldx     _string_off+1
L2C45:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L2A2C:	lda     _game_level_advance_behavior
	beq     L3BE5
	lda     _level_index
	cmp     #$18
	bne     L3BE6
