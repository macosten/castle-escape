...
;
	jmp     L4273
L4260:	lda     _valrigard+3
	cmp     #$F1
	bcc     L4261
	ldx     #$F0
	lda     #$00
L4273:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L4261:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L426B:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L426C:	lda     _valrigard+3
	cmp     #$F0
	bcc     L3840
;
...
; SET_STATUS_DEAD();    
;
L426D:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L3840:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L42D8:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L3176
L3174:	lda     _string_off
	ldx     _string_off+1
L3176:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L4307:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L312D
L312B:	lda     _string_off
	ldx     _string_off+1
L312D:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L4317:	lda     _level_index
	asl     a
	bcc     L430F
	inx
	clc
L430F:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
;
L431B:	lda     _game_level_advance_behavior
	beq     L431C
	lda     _level_index
	cmp     #$1C
	bne     L431D
