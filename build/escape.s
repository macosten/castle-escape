...
;
	jmp     L5A1E
L5A0B:	lda     _valrigard+3
	cmp     #$F1
	bcc     L5A0C
	ldx     #$F0
	lda     #$00
L5A1E:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L5A0C:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L5A16:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L5A17:	lda     _valrigard+3
	cmp     #$F0
	bcc     L4FE8
;
...
; SET_STATUS_DEAD();    
;
L5A18:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L4FE8:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L5A83:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L5AA4:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L48F6
L48F4:	lda     _string_off
	ldx     _string_off+1
L48F6:	sta     _temppointer
	stx     _temppointer+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L48C1
L48BF:	lda     _string_off
	ldx     _string_off+1
L48C1:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L5AC1:	lda     _level_index
	asl     a
	bcc     L5AB9
	inx
	clc
L5AB9:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
;
L5AC5:	lda     _game_level_advance_behavior
	beq     L5AC6
	lda     _level_index
	cmp     #$25
	bne     L5AC7
