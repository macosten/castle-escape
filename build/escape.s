...
L2B85:
	.byte	$31,$39,$3A,$34,$32,$3A,$30,$35,$00
L2599:
...
; valrigard.velocity_x = 0;
;
L3AD2:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L3185:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L3AEA
L3ADC:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3ADD
	ldx     #$F0
	lda     #$00
L3AEA:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3ADD:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3AE4:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L323A:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L3B3B:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L2C21
L2C1F:	lda     _string_off
	ldx     _string_off+1
L2C21:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L3B70:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L2BD8
L2BD6:	lda     _string_off
	ldx     _string_off+1
L2BD8:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L2A1D:	lda     _game_level_advance_behavior
	beq     L3B78
	lda     _level_index
	cmp     #$18
	bne     L3B79
