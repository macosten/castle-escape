...
L4CDB:
	.byte	$46,$65,$62,$20,$31,$38,$20,$32,$30,$32,$36,$00
L407C:
...
L4CE6:
	.byte	$32,$30,$3A,$31,$39,$3A,$35,$34,$00
L405A:
...
;
L5F11:	lda     _level_index
	asl     a
	bcc     L5F09
	inx
	clc
L5F09:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
; if (advanced_conditional && level_index_backup != 0xff) {
;
L4AF9:	lda     _advanced_conditional
	beq     L5F15
	lda     _level_index_backup
	cmp     #$FF
	beq     L5F15
...
;
L5F15:	lda     _game_level_advance_behavior
	beq     L5F16
	lda     _level_index
	cmp     #$25
	bne     L5F17
...
;
	jmp     L5F90
L5F7D:	lda     _valrigard+3
	cmp     #$F1
	bcc     L5F7E
	ldx     #$F0
	lda     #$00
L5F90:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L5F7E:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L5F88:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L5F89:	lda     _valrigard+3
	cmp     #$F0
	bcc     L553A
;
...
; SET_STATUS_DEAD();    
;
L5F8A:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L553A:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L5FF5:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L6016:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L4D6F
L4D6D:	lda     _string_off
	ldx     _string_off+1
L4D6F:	sta     _temppointer
	stx     _temppointer+1
;
...
; if (HAS_IGLOO_TROPHY) {
;
L4D8E:	lda     _igloo_1p_high_score
	cmp     #$E8
...
;
	...
	ldx     _string_on+1
	jmp     L4D3A
L4D38:	lda     _string_off
	ldx     _string_off+1
L4D3A:	sta     _temppointer
	stx     _temppointer+1
;
