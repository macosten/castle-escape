...
;
	...
	inx
	clc
L099F:	adc     #<(_korbat_sprite_lookup_table)
	sta     ptr1
	txa
...
; collision = c_map[coordinates];
;
L0971:	ldy     _coordinates
	lda     _c_map,y
L0A03:	sta     _collision
;
; if (METATILE_IS_SOLID(collision)) {
;
	cmp     #$17
...
;
	...
	sta     _enemies+64,y
;
; debug_tile_x = enemies.actual_y[x];
;
	ldy     _x
	lda     _enemies+64,y
	sta     _debug_tile_x
;
; debug_tile_y = enemies.nt[x];
;
	ldy     _x
	lda     _enemies+96,y
	sta     _debug_tile_y
