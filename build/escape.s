...
L49BD:
	.byte	$41,$75,$67,$20,$32,$32,$20,$32,$30,$32,$35,$00
L4052:
...
L49C8:
	.byte	$32,$33,$3A,$35,$32,$3A,$32,$32,$00
L4030:
...
;
L5B57:	lda     _level_index
	asl     a
	bcc     L5B4F
	inx
	clc
L5B4F:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
;
L5B5B:	lda     _game_level_advance_behavior
	beq     L5B5C
	lda     _level_index
	cmp     #$25
	bne     L5B5D
...
;
	jmp     L5BD6
L5BC3:	lda     _valrigard+3
	cmp     #$F1
	bcc     L5BC4
	ldx     #$F0
	lda     #$00
L5BD6:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L5BC4:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L5BCE:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L5BCF:	lda     _valrigard+3
	cmp     #$F0
	bcc     L5180
;
...
; SET_STATUS_DEAD();    
;
L5BD0:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L5180:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L5C3B:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L5C5C:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L4A51
L4A4F:	lda     _string_off
	ldx     _string_off+1
L4A51:	sta     _temppointer
	stx     _temppointer+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L4A1C
L4A1A:	lda     _string_off
	ldx     _string_off+1
L4A1C:	sta     _temppointer
	stx     _temppointer+1
;
