...
L2A9B:
	.byte	$30,$32,$3A,$31,$30,$3A,$30,$31,$00
L2596:
...
; valrigard.velocity_x = 0;
;
L3962:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L3015:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L397A
L396C:	lda     _valrigard+3
	cmp     #$F1
	bcc     L396D
	ldx     #$F0
	lda     #$00
L397A:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L396D:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3974:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L30CA:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L39CB:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
