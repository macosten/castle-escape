...
; valrigard.velocity_x = 0;
;
L0703:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L04E7:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
; draw_screen_D();
;
L041F:	jsr     _draw_screen_D
;
; draw_sprites();
;
L0422:	jsr     _draw_sprites
;
; while (1){
;
	jmp     L0411
