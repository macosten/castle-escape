...
L2E59:
	.byte	$31,$38,$3A,$35,$38,$3A,$33,$36,$00
L27F4:
...
; valrigard.velocity_x = 0;
;
L3E92:	sta     _valrigard+4
	stx     _valrigard+4+1
;
; valrigard.x += valrigard.velocity_x;
;
L34E1:	lda     _valrigard+4
	clc
	adc     _valrigard
	sta     _valrigard
	lda     _valrigard+4+1
...
;
	jmp     L3EAA
L3E9C:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3E9D
	ldx     #$F0
	lda     #$00
L3EAA:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3E9D:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3EA4:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L3596:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L3EFF:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L2EF5
L2EF3:	lda     _string_off
	ldx     _string_off+1
L2EF5:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L3F2E:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L2EAC
L2EAA:	lda     _string_off
	ldx     _string_off+1
L2EAC:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L2C90:	lda     _game_level_advance_behavior
	beq     L3F36
	lda     _level_index
	cmp     #$19
	bne     L3F37
...
;
L2CB6:	jsr     _gray_line
;
; while (game_mode == MODE_GAME) {
;
L3F41:	lda     _game_mode
	cmp     #$01
	jeq     L2C22
;
