...
L2EC0:
	.byte	$30,$31,$3A,$34,$36,$3A,$35,$35,$00
L285E:
...
;
	jmp     L3FD9
L3FC8:	lda     _valrigard+3
	cmp     #$F1
	bcc     L3FC9
	ldx     #$F0
	lda     #$00
L3FD9:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L3FC9:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L3FD3:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L35DB:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L403E:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L2F5C
L2F5A:	lda     _string_off
	ldx     _string_off+1
L2F5C:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L406D:	lda     _settings_menu_selector_x
	sta     _TEMP
	ldy     _menu_selection
...
;
	...
	ldx     _string_on+1
	jmp     L2F13
L2F11:	lda     _string_off
	ldx     _string_off+1
L2F13:	sta     _temppointer
	stx     _temppointer+1
;
...
;
L2CF7:	lda     _game_level_advance_behavior
	beq     L4076
	lda     _level_index
	cmp     #$1A
	bne     L4077
...
;
L2D1D:	jsr     _gray_line
;
; while (game_mode == MODE_GAME) {
;
L4081:	lda     _game_mode
	cmp     #$01
	jeq     L4075
;
