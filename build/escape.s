...
L49B6:
	.byte	$41,$75,$67,$20,$20,$38,$20,$32,$30,$32,$35,$00
L4052:
...
L49C1:
	.byte	$32,$31,$3A,$32,$37,$3A,$30,$37,$00
L4032:
...
;
L5B56:	lda     _level_index
	asl     a
	bcc     L5B4E
	inx
	clc
L5B4E:	adc     #<(_level_high_scores)
	sta     ptr1
	txa
	adc     #>(_level_high_scores)
	sta     ptr1+1
...
; if (advanced_conditional && level_index_backup != 0xff) {
;
L47D7:	lda     _advanced_conditional
	beq     L5B5A
	lda     _level_index_backup
	cmp     #$FF
	beq     L5B5A
...
;
L5B5A:	lda     _game_level_advance_behavior
	beq     L5B5B
	lda     _level_index
	cmp     #$25
	bne     L5B5C
...
;
	jmp     L5BD5
L5BC2:	lda     _valrigard+3
	cmp     #$F1
	bcc     L5BC3
	ldx     #$F0
	lda     #$00
L5BD5:	sta     _valrigard+2
	stx     _valrigard+2+1
;
; hitbox.x = high_byte(valrigard.x);
;
L5BC3:	lda     _valrigard+1
	sta     _hitbox
;
; hitbox.y = high_byte(valrigard.y);
;
...
; SET_STATUS_DEAD();
;
L5BCD:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; if (high_byte(valrigard.y) > 0xef) { 
;
L5BCE:	lda     _valrigard+3
	cmp     #$F0
	bcc     L517D
;
...
; SET_STATUS_DEAD();    
;
L5BCF:	lda     _player_flags
	ora     #$02
	sta     _player_flags
;
; temp5 = valrigard.y;
;
L517D:	lda     _valrigard+2+1
	sta     _temp5+1
	lda     _valrigard+2
	sta     _temp5
;
...
;
	...
	sta     _TEMP+1
	lda     #$01
L5C3A:	jsr     _add_scroll_y_fast_sub
	sta     _temp5
	stx     _temp5+1
;
...
;
L5C5B:	lda     _menu_selection_count
	sec
	sbc     #$01
	sta     _menu_selection
;
...
;
	...
	ldx     _string_on+1
	jmp     L4A4A
L4A48:	lda     _string_off
	ldx     _string_off+1
L4A4A:	sta     _temppointer
	stx     _temppointer+1
;
...
;
	...
	ldx     _string_on+1
	jmp     L4A15
L4A13:	lda     _string_off
	ldx     _string_off+1
L4A15:	sta     _temppointer
	stx     _temppointer+1
;
