...
// Remember GAME_PAUSED -> 0b00000001
#define HASEE_DID_SCORE_CHANGE_THIS_FRAME_MASK      0b00000010
#define HASEE_DID_BUFFER_MESSAGE_THIS_FRAME_MASK    0b00000100
// Flags that don't
#define HASEE_JUMPING_OFF_BRANCH_MASK               0b00001000
#define HASEE_JUMPING_TO_BRANCH_MASK                0b00010000
#define HASEE_LOCK_ON_PALETTE_2_MASK                0b00100000
#define HASEE_LOCK_ON_PALETTE_3_MASK                0b01000000
#define HASEE_SAD_ENDING_MASK                       0b10000000
...
#define HASEE_DID_BUFFER_MESSAGE_THIS_FRAME     (player_flags2 & HASEE_DID_BUFFER_MESSAGE_THIS_FRAME_MASK)
#define HASEE_SET_BUFFERED_MESSAGE_THIS_FRAME() (player_flags2 |= HASEE_DID_BUFFER_MESSAGE_THIS_FRAME_MASK)
...
#define HASEE_HAS_SAD_ENDING        (player_flags2 & HASEE_SAD_ENDING_MASK)
#define HASEE_SET_SAD_ENDING()      (player_flags2 |= HASEE_SAD_ENDING_MASK)

#define HASEE_RESET_PLAYER_FLAGS_START_FRAME() (player_flags2 &= ~(HASEE_DID_SCORE_CHANGE_THIS_FRAME_MASK | HASEE_DID_BUFFER_MESSAGE_THIS_FRAME_MASK))
