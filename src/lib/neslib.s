...
;and needs to match the bank where the music is
	...
	; Old: .export _oam_spr,_oam_meta_spr

	; New: Optimized, but macro-ified
	.export _oam_spr_fast_sub,_oam_meta_spr_fast_sub
...
.segment "ZEROPAGE"
	...
	.export _oam_spr_x,_oam_spr_y,_oam_spr_ptr
...
;void __fastcall__ oam_meta_spr_fast_sub(unsigned char x,unsigned char y,const unsigned char *data);
;sprid removed

_oam_meta_spr_fast_sub:
